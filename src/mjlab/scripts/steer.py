...
from mjlab.dynamics.steering import steer
from mjlab.tasks.pendulum.pendulum_steer_env_cfg import SteerEnvCfg
...
def run_steering(task: str, cfg: SteerConfig):
  ...
  cfg = SteerEnvCfg()
  breakpoint()
  traj_batch = steer(policy, 
                     cfg.mppi, 
                     env, 
                     cfg.reference_generator, 
                     cfg.key, 
                     cfg.command_indices,)
